...
- **v1.1.0 ～ v1.3.0（約33時間）**: 
  ...
  - 平均3時間 × 11日 ＝ 33時間
- **v2.0.0（約18時間）**: 
  1つのプルリクエストあたり30分前後と仮定し、合計24コミット行ったため、作業時間は12時間と概算しました。
  また、機能追加やリファクタリングの構想を考えるため、一日2時間かけたと仮定しました。
  - コミットあたり0.5時間 × 24回 ＝ 12時間
  - 平均構想時間2時間 × 3日 ＝ 6時間
- **v2.0.1 ～ v2.0.2（約4.5時間）**:
  v2.0.0と同様、1つのプルリクエストあたり30分前後と仮定しました。
  また、構想時間については、v2.0.2はほとんど行っていないので、v2.0.1のみ考えました。
  - 1プルリクエストあたり0.5時間 × 5回 ＝ 2.5時間
  - 構想時間2時間

合計: 約91.5時間（約90時間として記載）
</details>
